...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\FilterType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\FilterType']) ? $this->services['AppBundle\Form\FilterType'] : $this->services['AppBundle\Form\FilterType'] = new \AppBundle\Form\FilterType()) && false ?: '_'};
}, 'AppBundle\\Form\\TaskType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\TaskType']) ? $this->services['AppBundle\Form\TaskType'] : $this->load('getTaskTypeService.php')) && false ?: '_'};
