...
class appTestDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // task_list
        if ('' === $trimmedPathinfo) {
            $ret = array (  '_controller' => 'AppBundle\\Controller\\TaskController::listAction',  '_route' => 'task_list',);
            if ('/' === substr($pathinfo, -1)) {
                // no-op
            } elseif ('GET' !== $canonicalMethod) {
                goto not_task_list;
            } else {
                return array_replace($ret, $this->redirect($rawPathinfo.'/', 'task_list'));
            }
        ...
        if (0 === strpos($pathinfo, '/task')) {
            ...
            // task_check
            if (0 === strpos($pathinfo, '/task/check') && preg_match('#^/task/check/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'task_check')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::checkAction',));
            }
        ...
        elseif (0 === strpos($pathinfo, '/user')) {
            ...
            // user_update
            if (0 === strpos($pathinfo, '/user/update') && preg_match('#^/user/update/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
